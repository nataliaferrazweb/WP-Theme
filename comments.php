...
// Do not delete these lines
	...
	if ( post_password_required() ) { ?>
		<p class="nocomments">Este post é protegido por senha. Entre com a senha para ver os comentários.</p>
	<?php
		return;
	}
?>
...
<label for="author"><small>Nome <?php if ($req) echo "(*)"; ?></small></label></p>
...
<?php if ( have_comments() ) : ?>
	<div class="pagetitle" style="padding: 5px; text-align: center;"><?php comments_number('Comentários', '1 Comentário', '% Comentários' );?></div>
